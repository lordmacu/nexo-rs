...
| Cody-extraction | Cody persona out-of-tree (Phase A deudas + Phase B sibling repo) | 12/12 | ✅ shipped 2026-05-11 (deudas: 5/5; persona pack: 7/7; CLI install deferred to follow-up wave `cody-cli-install`) |
